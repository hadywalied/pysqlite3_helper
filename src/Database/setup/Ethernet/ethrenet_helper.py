...
class EthernetHelper(Helper):
    ...
    def __init__(self):
        ...
        super(EthernetHelper, self).__init__('src/Database/Ethernet/eth.db') #C:\\Users\\himep\\PycharmProjects\\pythonProject2\\src\\Database\\Ethernet\\eth.db src/Database/Ethernet/eth.db
        # self.create_tables()
